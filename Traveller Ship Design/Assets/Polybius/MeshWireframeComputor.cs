...
namespace AtomosZ.Polybius
{
	/// <summary>
	/// Completely stolen from Mina Pêcheux . <br/>
	/// https://github.com/MinaPecheux/unity-tutorials?tab=readme-ov-file.<br/>
	/// https://www.youtube.com/watch?v=xEmyl5_wYqk&list=PLbEtFK5YvXKXc6u9OxWYnMRyHIDUTwmgc&index=2
	/// </summary>
