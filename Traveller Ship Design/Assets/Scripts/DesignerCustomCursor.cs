...
{
	public class DesignerCustomCursor : MonoBehaviour
	{
		private static DesignerCustomCursor instance;
		...
		{
			if (instance == null)
				instance = GameObject.FindAnyObjectByType<DesignerCustomCursor>();
